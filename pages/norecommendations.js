        ...
        <div className="p-6">
          ...
          <div className="space-y-6 mt-8 lg:mt-0 max-w-[728px] mx-auto">
            ...
            <div className="text-center font-light text-lg">
              Sign up to speak to one of our friendly staff members. They will
              be able to walk you through all your options, and help find a way
              forward that suits your business.
              <br />
              <br />
