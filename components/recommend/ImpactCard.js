      ...
      <div className="flex flex-col gap-4 lg:gap-6 lg:flex-row">
        ...
        {btn1 || btn2 || btn3 ? (
          <p className="text-subTextColor mt-6 text-center lg:text-left col-span-2">
            ...
            {recommend === "solar" &&
              `If the average business in your industry uses Solar energy for its electricity needs, the avoided carbon emissions could equal to the removal of up to ${
          ...
          <p className="text-subTextColor mt-6 text-center lg:text-left col-span-2">
            ...
            {recommend === "greenPower" &&
              `If the average business in your industry buys (${
                level * 100
              }%) GreenPower, it would fund -Kw/h of renewable electricity being put back into the grid. This is roughly equivalent to the renewable electricity generated by a wind turbine in - .`}
            {recommend === "solar" &&
              `If the average business in your industry uses Solar energy for its electricity needs, the avoided carbon emissions could equal to the removal of up to -x car
               from Australia’s roads.`}
          </p>
        )}
      </div>
