      ...
      <div className="flex flex-col gap-4 lg:gap-6 lg:flex-row">
        ...
        <p className="text-subTextColor mt-6 text-center lg:text-left col-span-2">
          {recommend === "carbonOffset" &&
            `As an example, if the average business in your industry offsets its electricity use for one year, it would be roughly be the equivalent of the carbon ${impact} trees absorb per year.
            `}
          {recommend === "greenPower" &&
            `As an example, if the average business in your industry leverages ${
              level * 100
            }% GreenPower, it would enable ${dailyUsage}Kw/h  of renewable electricity to be put back into the grid such as that generated by ${impact} of a wind turbine.`}
          {recommend === "solar" &&
