          ...
          <p className="text-subTextColor mt-6 text-center lg:text-left col-span-2">
            ...
            {recommend === "greenPower" &&
              `If the average business in your industry buys (${
                level * 100
              }%) GreenPower, it would fund ${dailyUsage} kWh of renewable electricity being put back into the grid. This is roughly equivalent to the renewable electricity generated by a wind turbine in ${
