            ...
            <div>
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  ...
                  used {Math.round(low * 365)} kwh per year. Which, if offset
                  would roughly be equivalent to the carbon{" "}
                  {Math.round(
                ...
                <li>
                  ...
                  average used {Math.round(medium * 365)} kwh per year. Which,
                ...
                {high && (
                  <li>
                    ...
                    {Math.round(high * 365)} kwh per year. Which, if offset
                    would roughly be equivalent to the carbon{" "}
                    {Math.round(
          ...
          {showContent === "greenPower" && (
            <div>
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  Smaller customers (between 0 and 40kwh daily usage) on average
                  used {Math.round(low * 365)} kwh per year. Which, if replaced
                  with {level * 100}% GreenPower would enable the injection of
                  electricity into the grid such as that generated by{" "}
                  {`${
                ...
                {high && (
                  <li>
                    Larger customers (over 440 kwh daily usage) on average used{" "}
                    {Math.round(high * 365)} kwh per year. Which, if replaced
                    with {level * 100}% GreenPower would enable the injection of
                    electricity into the grid such as that generated by{" "}
                    {`${
            ...
            <div>
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  Smaller customers (between 0 and 40kwh daily usage) on average
                  used {Math.round(low * 365)} kwh per year. Which, if replaced
                  with Solar energy equals to emission reduction of removing{" "}
