            ...
            <div>
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  ...
                  used {Math.round((low * 365) / 12)} kwh per year. Which, if
                  offset would roughly be equivalent to the carbon{" "}
                  {Math.round(
                    ((low * 365 * 0.0072 + 0.0482 + Number.EPSILON) * 100) / 100
                  )}{" "}
                  trees absorb per year{" "}
                </li>
                <li>
                  Medium customers (between 40 and 440kwh daily usage) on
                  average used {Math.round((medium * 365) / 12)} kwh per year.
                  Which, if offset would roughly be equivalent to the carbon{" "}
                  {Math.round(
                    ((medium * 365 * 0.0072 + 0.0482 + Number.EPSILON) * 100) /
                      100
                  )}{" "}
                  trees absorb per year{" "}
                </li>
                {high && (
                  <li>
                    ...
                    {Math.round((high * 365) / 12)} kwh per year. Which, if
                    offset would roughly be equivalent to the carbon{" "}
                    {Math.round(
                      ((high * 365 * 0.0072 + 0.0482 + Number.EPSILON) * 100) /
                        100
                    )}{" "}
                    trees absorb per year{" "}
                  </li>
            ...
            <div>
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                ...
                <li>
                  Medium customers (between 40 and 440kwh daily usage) on
                  average used {Math.round((medium * 365) / 12)} kwh per year.
                  Which, if replaced with {level * 100}% GreenPower would enable
                  the injection of electricity into the grid such as that
                  generated by{" "}
                  {`${
            ...
            <div>
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                ...
                <li>
                  Medium customers (between 40 and 440kwh daily usage) on
                  average used {Math.round((medium * 365) / 12)} kwh per year.
                  Which, if replaced with Solar energy equals to emission
