    ...
    <Modal open={impactRanges} onClose={closeModal}>
      <Box className="bg-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-w-[350px] sm:max-w-[600px] min-w-[311px] p-6 rounded-lg">
        ...
        <div className="font-GorditaRegular text-sm mt-6 overflow-y-scroll max-h-[450px] lg:max-h-[550px] xl:max-h-[700px]">
          <p>
            The weighted average emission factor has been used across VIC, SA,
            NSW &amp; QLD.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            looked at the industry averages across Origin&apos;s small to medium
            business customer base and found:{" "}
          </p>
          <br />
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  <p className="mb-2">
                    ...
                    average used {separator(Math.round(low * 365))}kwh per year.
                    Which, if offset would roughly be equivalent to{" "}
                ...
                <li>
                  <p className="mb-2">
                    ...
                    year. Which, if offset would roughly be equivalent to{" "}
                ...
                {high && (
                  <li>
                    <p className="mb-2">
                      ...
                      offset would roughly be equivalent to{" "}
              ...
              <ul className="text-sm list-disc pl-5 space-y-2">
                <li>
                  <p className="mb-2">
                    Smaller customers (between 0 and 40kwh daily usage) on
                    average used {separator(Math.round(low * 365))}kwh per year.
                    Which, if replaced with ({level * 100}%) GreenPower would
                    enable the injection of electricity into the grid such as
                    that generated by{" "}
                    {`${
                ...
                <li>
                  <p className="mb-2">
                    Medium customers (between 40 and 440kwh daily usage) on
                    average used {separator(Math.round(medium * 365))}kwh per
                    year. Which, if replaced with ({level * 100}%) GreenPower
                    would enable the injection of electricity into the grid such
